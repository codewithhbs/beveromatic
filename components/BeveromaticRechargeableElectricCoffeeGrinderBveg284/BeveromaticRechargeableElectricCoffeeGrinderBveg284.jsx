...
const BeveromaticRechargeableElectricCoffeeGrinder = () => {
    ...
    const imageUrl = ['/productImage/BVEG284-1.jpg', '/productImage/BVEG284-2.jpg', '/productImage/BVEG284-3.jpg', '/productImage/BVEG284-4.jpg', '/productImage/BVEG284-5.jpg']
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-7xl mx-auto px-6 sm:px-6 lg:px-10 mt-24 md:mt-36">
                <div className='max-[769px]:mt-36'>
                    <img className="w-full h-full rounded-2xl" src={'/sliderImage/BVEG284.png'} alt="Manual Coffee Grinder" />
                </div>
            </div>
            {/* end of hero */}
                        ...
                        <div className="md:w-1/2">
                            <div className="space-y-4">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-dark">BVEG284</span>
                                </div>
                                <h2 className="text-4xl font-bold"> Beveromatic Rechargeable Electric Coffee Grinder</h2>
                                <p className="text-black leading-relaxed">BVEG284 is a compact, portable, and rechargeable electric coffee grinder.  Designed for the discerning coffee lover, the EG284 provides the precision of a professional burr grinder in a cordless, go-anywhere format, upholding Beveromatic's commitment to delivering a premium experience without compromise.</p>
                                <button
                    ...
                    <div className="mb-16">
                                            ...
                                            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                                                ...
                                                <div className="bg-[#fff2eb] shadow-amber-900/30 hover:shadow-xl transition-shadow p-6 rounded-xl text-center">
                                                    ...
                                                    <span className="text-[#3d1808] font-bold">Solid SS Steel Housing</span>
                                                ...
                                                <div className="bg-[#fff2eb] shadow-amber-900/30 hover:shadow-xl transition-shadow p-6 rounded-xl text-center">
                                                    ...
                                                    <span className="text-[#3d1808] font-bold">Precision Ceramic Conial Burr Grinder</span>
                                                ...
                                                <div className="bg-[#fff2eb] shadow-amber-900/30 hover:shadow-xl transition-shadow p-6 rounded-xl text-center">
                                                    ...
                                                    <span className="text-[#3d1808] font-bold">2 Li-ion Battery </span>
                                                ...
                                                <div className="bg-[#fff2eb] shadow-amber-900/30 hover:shadow-xl transition-shadow p-6 rounded-xl text-center">
                                                    ...
                                                    <span className="text-[#3d1808] font-bold">100 Grams Bean Capacity</span>
                                        ...
                                        <div className="bg-white border border-gray-300 mb-10 rounded-xl overflow-hidden">
                                            ...
                                            <table className="w-full">
                                                <tbody className='border border-gray-300'>
                                                    <TableRow icon={Coffee} label="Product" value='BVEG284' highlight />
                                                    <TableRow icon={Droplet} label="Product Type" value={'Rechargeable Electric Coffee Grinder'} />
                                                    <TableRow icon={Container} label="Model Number" value={'BVEG284'} highlight />
                                                    <TableRow icon={Power} label="Bean Capacity" value={'100 Grams'} />
                                                    <TableRow icon={Timer} label="Grind" value={'19 Grind Settings'} highlight />
                                                    ...
                                                    />
                                                    <TableRow icon={Coffee} label="Battery" value={'Yes, Li-ion'} highlight />
                                                    ...
                                                    <TableRow icon={Coffee} label="Color" value={'Black'} />
...
export default BeveromaticRechargeableElectricCoffeeGrinder;
