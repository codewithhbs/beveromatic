...
const ManualCoffeeGrinderBVCG64 = () => {
    ...
    const imageUrl = ['/productImage/product-1-BVCG64.webp', '/productImage/product-2-BVCG64.webp', '/productImage/product-3-BVCG64.webp', '/productImage/product-4-BVCG64.webp']
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-7xl mx-auto px-6 sm:px-6 lg:px-10 mt-24 md:mt-36">
                <div className='max-[769px]:mt-36'>
                    <img className="w-full h-full rounded-2xl" src={'/sliderImage/hero-banner-BVCG64.webp'} alt="Manual Coffee Grinder" />
                </div>
            </div>
            {/* end of hero */}
                    ...
                    <div className="bg-white border border-gray-300 mb-10 rounded-xl overflow-hidden">
                        ...
                        <table className="w-full">
                            <tbody className='border border-gray-300'>
                                <TableRow icon={Coffee} label="Product" value='Beveromatic Manual Coffee Grinder BVCG64' highlight />
                                <TableRow icon={Droplet} label="Product Type" value={'Manual Coffee Grinder'} />
                                <TableRow icon={Container} label="Model Number" value={'BVCG64'} highlight />
...
export default ManualCoffeeGrinderBVCG64;
