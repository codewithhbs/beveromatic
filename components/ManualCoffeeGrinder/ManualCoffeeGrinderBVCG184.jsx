...
const ManualCoffeeGrinderBVCG184 = () => {
    ...
    const imageUrl = ['/productImage/product-1-BVCG184.webp', '/productImage/product-2-BVCG184.webp', '/productImage/product-3-BVCG184.webp', '/productImage/product-4-BVCG184.webp']
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-7xl mx-auto px-6 sm:px-6 lg:px-10 mt-24 md:mt-36">
                <div className='max-[769px]:mt-36'>
                    <img className="w-full h-full rounded-2xl" src={'/sliderImage/hero-slider-BVCG184.webp'} alt="Manual Coffee Grinder" />
                </div>
            </div>
            {/* end of hero */}
                    ...
                    <div className="mb-16">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                            ...
                            <div className="bg-[#fff2eb] shadow-amber-900/30 hover:shadow-xl transition-shadow p-6 rounded-xl text-center">
                                ...
                                <span className="text-[#3d1808] font-bold">Steel </span>
                            ...
                            <div className="bg-[#fff2eb] shadow-amber-900/30 hover:shadow-xl transition-shadow p-6 rounded-xl text-center">
                                ...
                                <span className="text-[#3d1808] font-bold">18 Grams Bean Capacity</span>
                    ...
                    <div className="bg-white border border-gray-300 mb-10 rounded-xl overflow-hidden">
                        ...
                        <table className="w-full">
                            <tbody className='border border-gray-300'>
                                <TableRow icon={Coffee} label="Product" value='Beveromatic Manual Coffee Grinder BVCG184' highlight />
                                <TableRow icon={Droplet} label="Product Type" value={'Manual Coffee Grinder'} />
                                <TableRow icon={Container} label="Model Number" value={'BVCG184'} highlight />
                                <TableRow icon={Power} label="Bean Capacity" value={'18 Grams'} />
                                <TableRow icon={Timer} label="Grind" value={'6 Grind Settings'} highlight />
                                <TableRow icon={Droplet} label="Grind Burr Type" value={'Steel'} />
                                <TableRow
                                    icon={Container}
                                    label="Jar Type"
                                    value={`Glass`}
                                ...
                                <TableRow
                                    ...
                                    highlight
                                />
                                <TableRow icon={Scale} label="Knob Type" value={'Plastic'} />
                                ...
                                <TableRow icon={Coffee} label="Color" value={'Milky White'} />
...
export default ManualCoffeeGrinderBVCG184;
