    ...
    <div className="p-6 bg-gray-50 dark:bg-gray-800">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white dark:bg-gray-900 border rounded-lg shadow-sm p-4 col-span-1">
          <h3 className="text-lg font-semibold mb-4 dark:text-amber-50">Quick Actions</h3>
          <div className="space-y-4">
            <button
              className="w-full flex items-center justify-start  dark:text-amber-50 gap-2 border rounded-md px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-800"
